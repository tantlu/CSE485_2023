...
<?php   
    ...
    if(isset($_POST["sua"])){
        ...
        $tenbv = $_POST["txtCatName"];

        if($tenbv == ""){echo "Vui lòng nhập tên bài viết";}

        if($tenbv != ""){
            $sql = "update baiviet set tieude = '$tenbv' where ma_bviet = $id";
            $qr = mysqli_query($conn,$sql);
        ...
        <div class="row">
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtCatId" readonly value="<?php echo $rows['ma_bviet']; ?>">
                    </div>
